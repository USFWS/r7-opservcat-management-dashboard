...
return_arlis_list <- function(){
  arlis <- c("CeliaatARLIS", "CSwansonARLIS", "stevejarlis", "mwillis", "saddison2", "lohman.lucas", "Mwjohnson2", "ErinBentley", "Valerie-ARLIS", "thodges", "celia_rozen@fws.gov", "lauren_hintenlang@fws.gov")
  return(arlis)
}
